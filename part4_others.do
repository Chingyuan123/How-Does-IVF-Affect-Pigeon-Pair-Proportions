...
* Part 4: Calculation of the MLE standard errors of parameters and the values used in Figures 3a and 3b based on the estimates obtained in Part 3 (in STATA). 
*
*****
...
*            used in Figures 3a and 3b based on the estimates obtained in Part 3 
*            (in STATA). 
*           STATA version 15.0
*
*****
...
// Calculate the values for Figure 3a
...
// Calculate the values for Figure 3_b
// (two-boy)
use "IVF_data_02.dta", replace
gen total_twins =  var2+var3+var4+var5
